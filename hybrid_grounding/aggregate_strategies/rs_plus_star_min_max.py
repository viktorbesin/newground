...
class RSPlusStarMinMax:
    ...
    def _add_min_max_aggregate_rules(cls, str_type, aggregate_dict, variable_dependencies, aggregate_mode, cur_variable_dependencies, guard_domain, operator_type, string_capsulation, guard_string, rule_positive_body):
        ...
        if number_of_elements == 1 and (operator_type == ">=" or ">") and len(list(guard_domain)) == 1 and str_type == "max":
            ...
            if len(list(guard_domain)) == 1:
                ...
                cls._add_min_max_single_domain_adder(aggregate_dict, aggregate_mode, str_type, str_id, variable_dependencies, operator_type, string_capsulation, guard_value, cur_variable_dependencies, original_rule_additional_body_literals, new_prg_part_list, new_prg_part_set, [], guard_string, rule_positive_body)
                ...
                for guard_value in guard_domain_list:
                    ...
                    cls._add_min_max_single_domain_adder(aggregate_dict, aggregate_mode, str_type, str_id, variable_dependencies, operator_type, string_capsulation, guard_value, cur_variable_dependencies, original_rule_additional_body_literals, new_prg_part_list, new_prg_part_set, always_add_variable_dependecies, guard_string, rule_positive_body)
    ...
    @classmethod
    def _add_min_max_single_domain_adder(cls, aggregate, aggregate_mode, str_type, str_id, variable_dependencies, operator_type, string_capsulation, guard_value, cur_variable_dependencies, original_rule_additional_body_literals, new_prg_part_list, new_prg_part_set, always_add_variable_dependecies, guard_string, rule_positive_body):
        ...
        if len(variable_dependencies + always_add_variable_dependecies) == 0:
            ...
            head_terms_string = f"({','.join(variable_dependencies + always_add_variable_dependecies)})"
        ...
        if len(variable_dependencies + always_add_variable_dependecies) == 0:
            ...
            if len(always_add_variable_dependecies) == 0:
                ...
                original_rule_head_terms_string = f"({','.join(variable_dependencies + [guard_string])})"
